...
| `mcp.clientIdMetadataDocuments.fetchTimeoutMs`          | number   | `5000`          | HTTP fetch timeout for CIMD document retrieval (milliseconds)                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `mcp.clientIdMetadataDocuments.maxDocumentBytes`        | number   | `65536`         | Maximum CIMD document size in bytes (64 KB default). Responses exceeding this limit are rejected                                                                                                                                                                                                                                                                                                                                                                                                       |
